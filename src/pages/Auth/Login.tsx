    ...
    <div className="min-h-screen bg-echo-bg flex flex-col px-6 py-10 animate-fade">
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-white/50 text-sm mt-1">Sign in to Echo</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full bg-echo-card border border-echo-border rounded-2xl py-3.5 pl-11 pr-12 text-sm text-white placeholder-white/30 focus:outline-none focus:border-echo-blue/50 transition"
              />
              <button
                type="button"
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-xs text-echo-blue font-medium">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-echo-bg px-3 text-white/40">or continue with</span>
          </div>
        </div>

        <button
          onClick={handleGoogle}
          className="w-full py-3.5 rounded-2xl glass flex items-center justify-center gap-3 text-sm font-medium hover:bg-white/5 transition"
        >
        ...
        <p className="text-center text-sm text-white/50 mt-8">
          ...
          <Link to="/signup" className="text-echo-blue font-medium">
            Sign up
          </Link>
        </p>
      </div>
